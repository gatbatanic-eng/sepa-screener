...
# LLM(자연어 코멘트) 출력과 규칙 텍스트 양쪽에서 공통으로 검사하는 금지 표현.
# personas/generate.py 가 LLM 응답을 이 목록으로 검증하고, 걸리면 규칙 기반 텍스트로 대체한다.
FORBIDDEN_PHRASES = (
    "매수하세요", "매수 추천", "강력 매수", "매도하세요", "매도 추천", "사세요", "파세요",
    "지금 사", "지금 매수", "지금 진입하세요", "진입하세요", "보유하세요", "비중을 늘리세요", "비중을 줄이세요",
    "목표가", "익절하세요", "손절하세요", "BUY", "SELL",
)
